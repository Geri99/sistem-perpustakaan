...
class Menu extends CI_Controller
{
    ...
    public function editSubMenu($id)
    {
        ...
        $data['subMenu'] = $this->menu->getSubMenu();
        $data['menu'] = $this->db->get('user_menu')->result_array();
        $data['submenu'] = $this->menu->getSubByid($id);
    ...
    public function delete($id)
    {
        ...
        $this->menu->deleteRoom($id);
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Menu Berhasil di Delete </div> ');
        redirect('menu');
    }

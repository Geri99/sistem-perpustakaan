...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = "Sistem Perpustakaan | Login";
    ...
    public function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('message', ' <div class="alert alert-danger" role="alert"> This email has not beet activated </div>');
                redirect('auth');
            }
        } else {
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = "Sistem Informasi Laundry- Login";
            $this->load->view('templates/auth_header', $data);
